...
Các dependency tiền đăng ký đã đạt yêu cầu. Hồ sơ được khóa cục bộ ngày 31/07/2026 tại `artifacts/protocol-registration-lock-2026-07-31`, kèm danh mục tệp và checksum SHA-256. Bản đăng ký được chấp nhận/công khai tại [OSF `62b8w`](https://osf.io/62b8w/) ngày 31/07/2026, DOI [10.17605/OSF.IO/62B8W](https://doi.org/10.17605/OSF.IO/62B8W). Snapshot đã khóa không bị sửa đổi sau đăng ký.
...
| Ngày khóa cục bộ | `PASS` | 31/07/2026; đây là khóa gói nguồn, không phải xác nhận đã đăng ký. |
