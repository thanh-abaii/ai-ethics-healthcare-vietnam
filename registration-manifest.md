...
Các dependency tiền đăng ký đã đạt yêu cầu. Theo [`protocol-amendment-pr-03.md`](protocol-amendment-pr-03.md), hồ sơ được khóa cục bộ ngày 31/07/2026 tại `artifacts/protocol-registration-lock-2026-07-31`, kèm danh mục tệp và checksum SHA-256. Bản đăng ký được chấp nhận/công khai tại [OSF `62b8w`](https://osf.io/62b8w/) ngày 31/07/2026, DOI [10.17605/OSF.IO/62B8W](https://doi.org/10.17605/OSF.IO/62B8W). Việc ghi nhận hậu đăng ký ở [`protocol-amendment-pr-04.md`](protocol-amendment-pr-04.md) không sửa snapshot đã khóa.
...
Đã hoàn tất tải gói snapshot bất biến, metadata và kiểm tra locator. G4–G5 được phép chạy; mọi thay đổi phương pháp sau đăng ký phải được ghi bằng amendment mới, không sửa ngược gói đã khóa hoặc bản đăng ký.
