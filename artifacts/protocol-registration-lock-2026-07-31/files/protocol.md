...
| Trường                                           | Giá trị                                                                                                   |
| -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `protocol_version`                               | `0.5-ready-for-registration`                                                                              |
| Trạng thái đăng ký                            | `NOT_REGISTERED`                                                                                          |
| Mức sẵn sàng                                    | `LOCKED_LOCALLY_READY_FOR_OSF`                                                                            |
...
Protocol này đã hoàn tất các điều kiện tiên quyết tiền đăng ký và **được phép khóa cục bộ thành gói bất biến ngày 31/07/2026**. Protocol vẫn `NOT_REGISTERED`; việc khóa cục bộ không thay thế đăng ký trên OSF hoặc kho ổn định. Pilot khả thi G4–G5, tìm kiếm chính thức, sàng lọc và trích xuất dữ liệu chính thức chỉ được mở sau khi bản đăng ký có locator đã kiểm tra và các cổng tương ứng đạt điều kiện. Hoạt động `pre-registration search-development validation` tại Mục 9.3 đã hoàn tất ngày 31/07/2026 nhưng không tạo corpus hoặc count PRISMA.

Phiên bản `0.2-pre-registration` làm rõ câu hỏi và trường trích xuất về thể chế hóa, áp dụng, giám sát và bằng chứng kết quả/tác động. Phiên bản `0.3-pre-registration` ghi sửa đổi tiền đăng ký `PR-01` ngày 31/07/2026: thêm lý do loại toàn văn `EX09_WRONG_LANGUAGE` để sửa thiếu sót giữa tiêu chí chỉ nhận tiếng Việt/Anh và danh mục lý do loại chuẩn hóa. Phiên bản `0.4-pre-registration` ghi sửa đổi tiền đăng ký `PR-02` ngày 31/07/2026 tại [`protocol-amendment-pr-02.md`](protocol-amendment-pr-02.md): bỏ vai trò chuyên gia y tế và `TEAM_EXPERTISE_GATE`, giữ Đào Trung Thành và Lộc Đặng là hai người rà soát, đồng thời khóa ranh giới không thẩm định hoặc khuyến nghị lâm sàng độc lập. Phiên bản `0.5-ready-for-registration` ghi sửa đổi `PR-03` ngày 31/07/2026 tại [`protocol-amendment-pr-03.md`](protocol-amendment-pr-03.md): bỏ mốc chờ hành chính 15/08/2026 và cho phép khóa cục bộ ngay khi dependency tiền đăng ký đã đạt, không thay đổi phương pháp và không mở G4–G5 trước đăng ký.

### Trạng thái các cổng có liên quan

| Cổng/dependency                                      | Trạng thái hiện tại              | Hệ quả                                                                                                                                                                                                                                                                                                                          |
| ----------------------------------------------------- | ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| G1 — truy cập và xuất dữ liệu OpenAlex          | `PASS`                             | Đã chứng minh khả năng truy cập kỹ thuật; kết quả kiểm tra không thuộc tập nghiên cứu.                                                                                                                                                                                                                            |
| G2 — Lộc Đặng xác nhận vai trò bằng văn bản | `PASS`                             | Xác nhận ngày 31/07/2026 tại[`loc-dang-reviewer-confirmation.md`](loc-dang-reviewer-confirmation.md); không tự động xác nhận tư cách đồng tác giả.                                                                                                                                                               |
| G3 — novelty audit                                   | `PASS_WITH_NARROWED_CLAIM`         | Chỉ được giữ tuyên bố đóng góp đã thu hẹp tại Mục 4.                                                                                                                                                                                                                                                               |
...
G2, `SCREENING_EXTRACTION_CODEBOOK_GATE`, `PRISMA_SCR_PROTOCOL_MAP_GATE`, chiến lược tìm kiếm chính xác, bộ chuẩn quốc tế, competitive checkpoint và khai báo tài trợ đều đã có bằng chứng đạt yêu cầu để tạo gói đăng ký. `TEAM_EXPERTISE_GATE` là `NOT_APPLICABLE_SCOPE_NARROWED` theo `PR-02` và không còn là dependency. `PRISMA_SCR_MANUSCRIPT_GATE` không phải dependency tiền đăng ký; cổng này chỉ chặn nộp bài. G4–G5 vẫn `NOT_RUN` và chỉ được mở sau khi đăng ký.
...
Tại phiên bản `0.5-ready-for-registration`, quyết định hợp lệ là tạo snapshot bất biến, tính checksum và đăng ký protocol. Việc khóa cục bộ không tự mở pilot: G4–G5, tìm kiếm chính thức và sàng lọc vẫn bị chặn cho đến khi locator của bản đăng ký được kiểm tra và các điều kiện chuyển giai đoạn được đáp ứng.
