# Quarantine — search-run-2026-07-31
...
Official rerun độc lập được thực hiện tại `artifacts/search-rerun-01-2026-07-31/` theo `OFFICIAL-SEARCH-REEXECUTION-RUNBOOK.md` và protocol OSF đã khóa.
